...
private let log = Logger(subsystem: "com.example.SawtoothSynthesizer.Synth", category: "AudioUnitViewController")

public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
    var audioUnit: AUAudioUnit?
    
    var hostingController: HostingController<SynthMainView>?
	...
	*/
    ...
    public func createAudioUnit(with componentDescription: AudioComponentDescription) throws -> AUAudioUnit {
        audioUnit = try SynthAudioUnit(componentDescription: componentDescription, options: [])
        
        guard let audioUnit = self.audioUnit as? SynthAudioUnit else {
            log.error("Unable to create SynthAudioUnit")
            return audioUnit!
        }
    ...
    private func configureSwiftUIView(audioUnit: AUAudioUnit) {
        ...
        let content = SynthMainView(parameterTree: observableParameterTree)
